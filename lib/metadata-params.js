...
const buildSelectorRowForType = function(type, record, selectedRecordsForType) {
    return selectorRowByType[type](record, getRecordIsSelected.call(this, selectedRecordsForType, record));
}
