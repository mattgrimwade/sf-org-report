...
function getRecordIsSelected(selectedRecords, rows) {
    if (selectedRecords && selectedRecords.length > 0) 
        rows.forEach(row => this.previouslySelectedIds = selectedRecords.find(selectedRecord => selectedRecord.Id == row.Id);
}
...
export { metadataTypes, queryStringByType, selectorColumnHeadersByType, buildSelectorRowForType, buildReportRowForType, reportColumnHeadersByType, getRecordIsSelected };