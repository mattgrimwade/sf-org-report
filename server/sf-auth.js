...
const oauth2 = new jsforce.OAuth2({
    ...
    redirectUri : process.env.NODE_ENV == 'production' ? 'https://serene-mesa-23595.herokuapp.com/projects/org-report/oauth2/callback' : 'https://localhost:3006/projects/org-report/oauth2/callback'
});
